...
SCENARIOS = [
    ...
    (31, "test", "classroom", "Student drops the crumpled quiz on desk and stands turned away sad arms slack no gesture", "sad", "none", "stepping_back", "stationary", "", "F10", "A12"),
    ...
    (50, "train", "kitchen", "Person sits down heavily sad staring at failed dish hands in lap no gesture", "sad", "none", "sitting", "stationary", "", "F10", "A12"),
    (51, "train", "kitchen", "Person stares at burnt cake shoulders dropped sad standing motionless", "sad", "none", "standing", "stationary", "", "F10", "A12"),
    ...
    (62, "test", "kitchen", "Person slumps forward over counter head down over failed dish sad no gesture", "sad", "none", "stepping_back", "stationary", "", "F10", "A12"),
    ...
    (72, "test", "kitchen", "Paramedic pushing gurney walks rapidly down corridor toward robot neutral waving aside", "sad", "none", "sitting", "stationary", "", "F10", "A11"),
    (73, "test", "kitchen", "Paramedic pushing gurney walks rapidly down corridor toward robot neutral waving aside", "sad", "none", "sitting", "stationary", "", "F10", "A11"),
]
